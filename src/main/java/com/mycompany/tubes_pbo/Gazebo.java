...
public class Gazebo extends FasilitasPantai {
    ...
    public Gazebo(String facilityID, String lokasi, String status,
                  int capacity, double hourlyRate, boolean isRented) {
    ...
    public String bookGazebo() {
        ...
        return "Gazebo " + facilityID + " berhasil dipesan. Tarif: Rp"
             + String.format("%,.0f", hourlyRate) + "/jam";
    }
